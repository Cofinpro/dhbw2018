...
class ChemicalElementTest {
    ...
    //arrange
    ChemicalElement H = new ChemicalElement(1,1,1, "H", "Wasserstoff");
    ChemicalElement Mg = new ChemicalElement(12,3,2,"Mg","Magnesium");
    ChemicalElement Hg = new ChemicalElement(80,6,12,"Hg","Quecksilber");
    ChemicalElement K = new ChemicalElement(19,4,1,"K","Kalium");
